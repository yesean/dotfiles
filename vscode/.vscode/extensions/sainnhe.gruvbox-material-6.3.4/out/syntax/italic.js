...
function getItalicSyntax(palette, italicComments) {
    let syntax = [
        ...
        {
            name: "C++ orange",
            scope: "storage.type.built-in.primitive.cpp, storage.type.built-in.cpp, storage.type.struct.cpp, entity.name.type.cpp, entity.name.type.parameter.cpp, entity.name.function.operator",
            settings: {
                foreground: palette.orange,
            },
        },
